...
console.log(`The ${tRex.name} weighs: ${tRex.weight}kg.`);

// What was the diet of a velociraptor?
console.log(`The ${raptor.name} is ${tRex.diet}.`);

// How long was a stegosaurus?
console.log(`The ${stego.name} is ${stego.length} meters long.`);
...
*/
const lowerPopulation = zooAnimals.filter(aniimal => aniimal.population < 5);
